...
os.chdir('/media/robbinsr/a94ffb60-544f-46c2-874c-bab46457fdb6/robbinsr_/' +
         'Projects/p_projects/nhis_exploratory/test')

custom_parser_input_file_name = "test.dat"
custom_parser_program_file_name = "test_parser.py"
custom_parser_output_file_name = "test_data.csv"
element_names_file_name = 'test_element_names.txt'
element_positions_file_name = "test_element_positions.txt"
error_log_file_name = "test_error_log.txt"
